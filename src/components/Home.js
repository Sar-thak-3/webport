...
const Home = (props)=>{
    return (
        <>
        <Helmet><script src="./Homejs.js" type="text/javascript"/></Helmet>
    ...
    <nav class="main-header__navigation">
      <ul class="main-header__navigation-links">
        ...
        <li class="main-header__navigation-link"><a href="./index.html#contact"> Contact </a></li>
      </ul>
    </nav>
        ...
        <div class="about__info">
          <div class="about__main-info">
            ...
            <p class="text-primary about__text-primary">
              <span>
                I am Sarthak Garg, basically from Dehradun, Uttarkhand. Currently I am staying in Chandigarh and pursuing Undergraduate degree from Punjab Engineering College, Chandigarh in Electrical Stream.
              </span>
              <span>
                I am highly passionate about Software Development. I have various skills in Development like Artificial Intellingence, Web Development, Web Automation, Web scraping, Operating Systems, and Computer Networking.
              </span>
              <span>
        ...
        <div class="projects__list">
          <div class="projects__list-item">
            ...
            <div class="projects__list-item-details">
              ...
              <p class="text-primary projects__list-item-text-primary">
                <span>
                  <ul style={{listStyle: "circle"}}>
                    <li>Cloud database for users to store their curriculum notes</li>
                    <li>Huge database of questions & answers related to any curriculum</li>
                    <li>Text data extracted from images posted by users on their database</li>
                    <li>Text data is processed to extract out every possible question</li>
                    <li>Data is then available freely to users to search and post their questions</li>
                  </ul>
                </span>
                {/* <!-- <br /> */}
                  {/* <br /> */}
          ...
          <div class="projects__list-item projects__list-item--inv">
            <div class="projects__list-item-details">
              ...
              <p class="text-primary projects__list-item-text-primary">
                <span>
                  <ul style={{listStyle: "circle"}}>
                    <li>LSTM & Convolutional model to caption the images</li>
                    <li>
                        69k images used to train the model.
                    </li>
              ...
              <a href="https://github.com/Sar-thak-3/Image-Captioning-Bot" class="btn btn-theme projects__btn-theme">
                Live Link
              </a>
              <a href="https://github.com/Sar-thak-3/Image-Captioning-Bot" class="btn btn-inv projects__btn-inv">Code Link</a>
            </div>
            <div class="projects__list-item-count">
          ...
          <div class="projects__list-item">
            ...
            <div class="projects__list-item-details">
              ...
              <p class="text-primary projects__list-item-text-primary">
                <span>
                  <ul style={{listStyle: "circle"}}>
                    <li>Anonymously create an account, no email/phone number required</li>
                    <li>Anonymously like/share/comment posts</li>
                    <li>Post your feelings/emotions as any other social media just anonymously</li>
                  </ul>
                </span>
                {/* <!-- <br />
                  <br /> --> */}
          ...
          <div class="projects__list-item projects__list-item--inv">
            <div class="projects__list-item-details">
              ...
              <p class="text-primary projects__list-item-text-primary">
                <span>
                  Entire health data of every country, state, city under one website. Plotly is used to plot the data of each each place and each year to show the data in interactive way.
                  It shows the new diagnosed, recovered patients and total diagnosed in the particular year/month of the particular disease in the particular area.
                </span>
                {/* <!-- <br />
                  <br /> --> */}
                <span>
              ...
              <a href="https://healdata.vercel.app/" class="btn btn-theme projects__btn-theme">
                Live Link
              </a>
              <a href="https://github.com/Sar-thak-3/Healdata" class="btn btn-inv projects__btn-inv">Code Link</a>
            </div>
            <div class="projects__list-item-count">
          ...
          <div class="projects__list-item">
            ...
            <div class="projects__list-item-details">
              ...
              <p class="text-primary projects__list-item-text-primary">
                <span>
                  Covid Detection using Deep Learning model on X-ray images of chest. Convolutional model is used to predict the covid. Data is trained on 50k+ x-ray images and achieved greated than 95.5% accuracy.
                </span>
                {/* <!-- <br />
                  <br /> --> */}
                <span>
              ...
              <a href="https://github.com/Sar-thak-3/Covid-Detection" class="btn btn-theme projects__btn-theme">
                Live Link
              </a>
              <a href="https://github.com/Sar-thak-3/Covid-Detection" class="btn btn-inv projects__btn-inv">Code Link</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="main-footer__bottom">
      <div class="main-container">
        <p class="main-footer__bottom-txt">
          ...
          <a target="_blank" rel="noreferrer" href="https://github.com/Sar-thak-3/webport">Webport</a> All rights reserved @ 2023
        </p>
      </div>
    </div>
  </footer>
